...
from mt_aptos.metagraph.metagraph_datum import MinerDatum  # <<<--- Chỉ cần MinerDatum
from mt_aptos.formulas import update_trust_score  # Import hàm cập nhật trust
...
from mt_aptos.service.utxos import get_utxo_from_str  # Hàm tìm UTXO theo UID
from mt_aptos.smartcontract.validator import read_validator  # Để lấy script hash/bytes
