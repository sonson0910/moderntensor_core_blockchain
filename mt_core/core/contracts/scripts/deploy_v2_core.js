...
async function main() {
    console.log("🚀 DEPLOYING ModernTensorAI v2.0 - Core Edition");
    console.log("=" * 60);
    ...
    const ModernTensorAI_v2 = await ethers.getContractFactory("ModernTensorAI_v2_Core");
