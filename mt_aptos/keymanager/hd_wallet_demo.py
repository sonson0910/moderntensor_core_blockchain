...
def demo_hd_wallet_system():
    ...
    console.print(Panel.fit(
        ...
        "[yellow]This demo shows how to use the Bittensor-style HD wallet system for Aptos[/yellow]",
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        console.print(f"[green]✅ Coldkey account: {str(coldkey_account.address())}[/green]")
        
        # Get hotkey account
        hotkey_account = wm.get_account(wallet_name, "validator", "validator_1")
        console.print(f"[green]✅ Hotkey account: {str(hotkey_account.address())}[/green]")
        ...
        console.print(f"[green]✅ Coldkey private key: {coldkey_private[:20]}...[/green]")
        ...
        for wallet in wallets:
            status = "✅ Available" if wallet in [wallet_name, restored_wallet] else "❌ Not loaded"
