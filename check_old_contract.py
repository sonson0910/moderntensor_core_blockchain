...
def check_old_contract():
    ...
    # Contract addresses for comparison
    old_contract = (
        "0x3dACb0Ac7A913Fa94f383f7d6CF0a7BC2b5498DD"  # Keep as old for comparison
    )
    new_contract = (
        "0x56C2F2d0914DF10CE048e07EF1eCbac09AF80cd2"  # Current deployed contract
    )
    ...
    try:
        ...
        client.contract = client.web3.eth.contract(
            address=old_contract, abi=client.contract.abi
        )
        ...
        print(f"\n📊 SUMMARY:")
        print(
            f"   Found {found_count}/{len(entities_addresses)} entities on old contract"
        )
